...
import br.com.ghdpreto.gestao_vagas.modules.candidate.useCases.ApplyJobCandidateUseCase;
import br.com.ghdpreto.gestao_vagas.modules.candidate.useCases.CreateCandidateUseCase;
import br.com.ghdpreto.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
import br.com.ghdpreto.gestao_vagas.modules.candidate.useCases.ProfileCandidateUseCase;
...
public class CandidateController {
    ...
    @GetMapping("job")
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Listagem de vagas disponiveis", description = "Essa função é responsável por listar todas as vagas disponíveis baseadas no filtro")
    @SecurityRequirement(name = "jwt_auth")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
